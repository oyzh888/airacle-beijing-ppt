(function initAISearchDemo() {
  ...
  const scenarios = [
    ...
    },
    {
      ...
      results: [
        { rank: '01', name: 'Nara Smith', handle: '@naraaziza · 家庭 / 育儿 / 高互动生活方式', tags: ['母婴适配', '家庭消费', '直播潜力'], score: 94, reason: '适合高信任度家庭消费品内容植入与长期品牌合作。', url: 'https://www.tiktok.com/@naraaziza?lang=en' },
        { rank: '02', name: 'Maia Knight', handle: '@maiaknight · 双胞胎育儿 / 高频家庭内容', tags: ['家庭场景强', '互动高', '转化友好'], score: 91, reason: '内容场景天然适合母婴品类展示与实用型种草。', url: 'https://www.tiktok.com/@maiaknight?lang=en' },
        { rank: '03', name: 'Mommyfarmer', handle: '@mommyfarmer · 家庭日常 / 生活方式', tags: ['中产家庭', '生活方式', '品牌融合自然'], score: 88, reason: '适合中高客单母婴、家居与家庭类品牌合作。', url: 'https://www.tiktok.com/@mommyfarmer?lang=en' }
      ]
    },
    {
      ...
      results: [
        { rank: '01', name: 'Typical Gamer', handle: '@typicalgamer · 游戏娱乐 / 主播切片内容', tags: ['男性受众', '传播效率高', '新游冷启适配'], score: 95, reason: '适合新游上线初期的高频曝光与短视频切片扩散。', url: 'https://www.tiktok.com/@typicalgamer?lang=en' },
        { rank: '02', name: 'Nickmercs', handle: '@nickmercs · 硬核竞技 / 社区影响力强', tags: ['核心玩家', '男性受众强', '社区号召力'], score: 92, reason: '适合竞技类和重度游戏用户心智建立。', url: 'https://www.tiktok.com/@nickmercs?lang=en' },
        { rank: '03', name: 'CouRageJD', handle: '@couRageJD · 娱乐型游戏内容 / 品牌合作成熟', tags: ['品牌经验足', '泛游戏传播', '商业化成熟'], score: 89, reason: '适合兼顾圈层传播与品牌安全性的合作需求。', url: 'https://www.tiktok.com/@couRageJD?lang=en' }
      ]
    }
  ];
  ...
  function renderScenario(s) {
    ...
    resultsEl.innerHTML = s.results.map((r, i) => `
      <div class="search-result-card${i === 0 ? ' active' : ''}" data-reason="${r.reason.replace(/"/g, '&quot;')}" data-url="${(r.url || '').replace(/"/g, '&quot;')}">
        ...
        <button class="search-action" type="button">打开主页</button>
      </div>
    `).join('');
